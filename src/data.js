...
const B = 'https://fitnessprogramer.com/wp-content/uploads'
// Verified working GIF URLs
const G = {
  pb:   `${B}/2021/02/Barbell-Bench-Press.gif`,
  pi:   `${B}/2021/02/Incline-Dumbbell-Press.gif`,
  fo:   `${B}/2021/06/Chest-Dips.gif`,
  ap:   `${B}/2021/02/Cable-Crossover.gif`,
  et:   `${B}/2021/02/Pushdown.gif`,
  pf:   null,
  jp:   `${B}/2021/02/Lat-Pulldown.gif`,
  je:   `${B}/2021/06/Close-Grip-Lat-Pulldown.gif`,
  rb:   `${B}/2021/02/Barbell-Bent-Over-Row.gif`,
  rs:   `${B}/2021/02/Seated-Cable-Row.gif`,
  cb:   `${B}/2021/02/Barbell-Curl.gif`,
  cm:   `${B}/2021/02/Hammer-Curl.gif`,
  sq:   `${B}/2023/01/Dumbbell-Goblet-Squat.gif`,
  pr:   null,
  pmr:  `${B}/2022/01/Stiff-Leg-Deadlift.gif`,
  cf:   `${B}/2021/02/Leg-Curl.gif`,
  ec:   null,
  gp:   `${B}/2021/06/Standing-Calf-Raise.gif`,
  pm:   `${B}/2021/04/Barbell-Military-Press.gif`,
  el:   `${B}/2021/02/Dumbbell-Lateral-Raise.gif`,
  pp:   `${B}/2021/02/Dumbbell-Reverse-Fly.gif`,
  fp:   `${B}/2021/02/Face-Pull.gif`,
  entr: `${B}/2021/04/Dumbbell-Shrug.gif`,
  pl:   `${B}/2021/02/plank.gif`,
  crp:  `${B}/2021/02/Kneeling-Cable-Crunch.gif`,
  evp:  `${B}/2021/08/Hanging-Leg-Raises.gif`,
  sg:   `${B}/2023/01/Dumbbell-Goblet-Squat.gif`,
  pman: `${B}/2021/02/Dumbbell-Press.gif`,
  rman: `${B}/2021/02/Dumbbell-Row.gif`,
  pmk:  `${B}/2021/06/Trap-Bar-Deadlift.gif`,
  bur:  null,
  planv:`${B}/2021/02/plank.gif`,
}
